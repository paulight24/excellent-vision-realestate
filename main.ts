...
// ── Interfaces (become Angular models) ──────────────────────
  ...
  private listings: Listing[] = [
    {
      ...
      cleaningFee: 150,
      description:
        'Elegant apartment with direct terrace access and garden views in Newport Beach. ' +
    ...
    },
    {
      ...
      cleaningFee: 150,
      description:
        'Sister unit to Unit A — same building, same premium amenities. ' +
    ...
    },
    {
      ...
      deposit: 1000,
      description:
        'Spacious 4-bedroom, 2-bathroom house perfect for families, remote workers, or adventure seekers. ' +
...
class ModalComponent {
  ...
  private updateGallery(): void {
    ...
    if (counter) counter.textContent = `${this.currentSlide + 1} / ${this.photos.length}`;
  }
  ...
  private renderModal(listing: Listing): void {
    ...
    if (listing.deposit) fees.push(`Refundable deposit: $${listing.deposit}`);
...
class CardComponent {
  ...
  private updateDots(id: string, active: number): void {
